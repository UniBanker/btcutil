...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/unibanker/btcutil/txsort)
...
```bash
$ go get -u github.com/unibanker/btcutil/txsort
```
